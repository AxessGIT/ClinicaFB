...
namespace ClinicaFB.Ingresos
{
    public partial class CfdiVisor : Form
    {
        ...
        private void CfdiVisor_Load(object sender, EventArgs e)
        {
            CargaDatos();
            SetGrid();
            CalculaTotales();
        ...
        private void SetGrid()
        {
            ...
            grdConceptos.Columns[0].DataPropertyName = "NoIden";
            ...
            grdConceptos.Columns[3].DataPropertyName = "ValorUnitario";
        ...
        private void CargaDatos()
        {
            ...
            {
                string sql = Queries.FacturaSelect();
                CFDI cfdi = db.Query<CFDI>(sql, new {CfdiId = _cfdId}).FirstOrDefault();
                ...
                txtSerie.Text = cfdi.Serie;
                txtFolio.Text = cfdi.Folio.ToString();
                dtpFecha.Value = cfdi.Fecha;
                txtEmisorNombre.Text = cfdi.EmisorNombre;
                txtReceptorRFC.Text = cfdi.ReceptorRFC;
                txtReceptorNombre.Text = cfdi.NomRec;
                txtPacienteNombre.Text = cfdi.NomPac;
                txtUID.Text = cfdi.uid;
                chkCancelada.Checked = cfdi.Cancelado;
                txtAcuse.Text = cfdi.AcuseCan;
                txtCVEFOP.Text = cfdi.FormaPago;
                txtCVEMEP.Text = cfdi.MetodoPago;
                txtCVEUSO.Text = cfdi.UsoCFdi;
