...
{
    public partial class FacturarOpciones : Form
    {
        public long RazonSocialId { get; set; } = 0;
        ...
        public FacturarOpciones(long razonSocialId,
            string cveFOP="", string cveMEP = "",
            string cveUSO = "",string correos="", 
            bool selRazon=false)
        {
            InitializeComponent();
        ...
        private void ClavesSATSeleccionar_Load(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(_cveFOP)==false)
            {
